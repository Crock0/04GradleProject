    ...
    public void showToast(View view){
        switch (view.getId()){
            ...
            case R.id.infoButton:
                Toasty.info(this,"Login detail",Toast.LENGTH_SHORT).show();
                break;
            case R.id.warningButton:
                Toasty.warning(this,"OppsS!",Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageButton:
                Toasty.normal(this,"Uploaded",Toast.LENGTH_SHORT,ContextCompat.getDrawable(this,R.drawable.ic_file_upload)).show();
                break;
        }
